		...
		out.println("<html>"
            ...
            +"<body>"
                ...
                +"<form class='formEdit' action='./ProcessaCriacao.do' method='post'>"
                    ...
                    +"<label>Descrição</label><br><textarea name='descricao'>"+noticia.getDescricao()+"</textarea><br>"
                    +"<label>Texto</label><br><textarea name='texto'>"+noticia.getTexto()+"</textarea><br>"
                    +"<button type=submit>"
                        +"Editar"
                    +"</button>"
                +"</form>"
